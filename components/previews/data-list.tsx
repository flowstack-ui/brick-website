...
export default function DataListPreview() {
  return <DataList.Root divide labelWidth="sm" orientation={{ initial: "vertical", md: "horizontal" }}><DataList.Item><DataList.Label>Release</DataList.Label><DataList.Value>Brick 0.1.12</DataList.Value></DataList.Item><DataList.Item><DataList.Label>Status</DataList.Label><DataList.Value>Ready to verify</DataList.Value></DataList.Item><DataList.Item><DataList.Label>Owners</DataList.Label><DataList.Value>95 components</DataList.Value></DataList.Item></DataList.Root>;
}
