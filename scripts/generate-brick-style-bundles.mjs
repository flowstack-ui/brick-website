...
const shellWebsiteStyles = `${websiteStyles.slice(0, docsStart)}${websiteStyles.slice(docsEnd + docsEndMarker.length, relationshipsStart)}${websiteStyles.slice(relationshipsEnd + relationshipsEndMarker.length)}`;
