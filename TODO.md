...
- Test the website-owned published-CSS bundler in a second static product
  before deciding whether its route-manifest and request-consolidation contract
  belongs in a future Flowstack Engine package.
