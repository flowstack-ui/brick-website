    ...
    <>
      ...
      <main id="main-content">
        <section className="hero section-shell">
          <div className="hero-copy">
            ...
            <HStack gap="3" wrap className="hero-actions">
              ...
              <WebsiteButton href="/components" size="lg" tone="neutral" variant="soft">Explore 80 components</WebsiteButton>
            </HStack>
            <InstallCommand />
        ...
        <section className="principles section-shell" aria-labelledby="principles-title">
          <div className="section-heading promise-heading">
            <Badge variant="outline" tone="neutral">The Brick promise</Badge>
            <Text as="h2" id="principles-title" variant="display" align="start" wrap="balance">A strong visual layer, without the platform weight.</Text>
            <Text as="p" variant="body-lg" tone="secondary" align="start" wrap="pretty">Brick sits between headless primitives and a sprawling UI platform: focused, polished, and explicit about what your application still owns.</Text>
          </div>
