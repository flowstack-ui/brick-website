...
export const metadata: Metadata = createPageMetadata({
  ...
  description: "Explore 80 finished, accessible React component owners with live examples, practical guidance, APIs, styling hooks, and package provenance.",
  path: "/components",
});
  ...
  return (
    <main id="main-content" className="catalog-shell section-shell">
      <div className="catalog-page">
        <Badge tone="accent" variant="soft">80 component owners</Badge>
