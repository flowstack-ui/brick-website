...
import { Bell, Check, Home, Inbox, Menu, Search, Settings, Star } from "lucide-react";
...
export function ComponentPreview({ slug }: { slug: string }) {
  switch (slug) {
    ...
    case "field": return <Field.Root id="preview-email" required><Field.Label>Email <Field.RequiredIndicator /></Field.Label><Input type="email" placeholder="you@example.com" /><Field.Description>Use your work address.</Field.Description></Field.Root>;
    ...
    case "hover-card": return <HoverCard.Root><HoverCard.Trigger asChild><a href="#ada">Ada Lovelace</a></HoverCard.Trigger><HoverCard.Portal><HoverCard.Content><VStack gap="2"><Avatar alt="Ada Lovelace" fallback="AL" /><Text as="span" weight="semibold">Ada Lovelace</Text><Text tone="secondary">Mathematician and writer</Text></VStack></HoverCard.Content></HoverCard.Portal></HoverCard.Root>;
    ...
    case "menubar": return <Menubar.Root><Menubar.Menu value="file"><Menubar.Trigger>File</Menubar.Trigger><Menubar.Portal><Menubar.Content><Menubar.Item value="new">New project</Menubar.Item><Menubar.Item value="open">Open</Menubar.Item></Menubar.Content></Menubar.Portal></Menubar.Menu><Menubar.Menu value="edit"><Menubar.Trigger>Edit</Menubar.Trigger><Menubar.Portal><Menubar.Content><Menubar.Item value="undo">Undo</Menubar.Item></Menubar.Content></Menubar.Portal></Menubar.Menu></Menubar.Root>;
    ...
    case "sidebar": return <Sidebar.Root className="preview-sidebar" collapsedState="rail"><Sidebar.Trigger aria-label="Toggle preview sidebar"><Menu /></Sidebar.Trigger><Sidebar.Panel aria-label="Workspace tools"><Sidebar.Header>Workspace</Sidebar.Header><Sidebar.Content><VStack gap="2"><Link href="#projects">Projects</Link><Link href="#settings">Settings</Link></VStack></Sidebar.Content><Sidebar.Footer>Flowstack</Sidebar.Footer></Sidebar.Panel><Sidebar.Main><Surface inset="md" level="subtle">Main workspace</Surface></Sidebar.Main></Sidebar.Root>;
    ...
    case "swipeable-item": return <SwipeableItem.Root variant="outline"><SwipeableItem.Actions aria-label="Archive actions" side="start"><Button>Archive</Button></SwipeableItem.Actions><SwipeableItem.Content><HStack justify="between"><Text>Quarterly report</Text><Badge>Ready</Badge></HStack></SwipeableItem.Content><SwipeableItem.Actions aria-label="Delete actions" side="end"><Button tone="danger">Delete</Button></SwipeableItem.Actions></SwipeableItem.Root>;
    ...
    case "tree": return <Tree.Root aria-label="Repository" defaultExpandedValue={["src"]}><Tree.Item value="src"><Tree.ItemContent><Tree.Indicator /><Tree.ItemText>src</Tree.ItemText></Tree.ItemContent><Tree.Group><Tree.Item value="components"><Tree.ItemContent><Tree.Indicator /><Tree.ItemText>components</Tree.ItemText></Tree.ItemContent></Tree.Item><Tree.Item value="index"><Tree.ItemContent><Tree.Indicator /><Tree.ItemText>index.ts</Tree.ItemText></Tree.ItemContent></Tree.Item></Tree.Group></Tree.Item></Tree.Root>;
    case "tree-grid": return <TreeGrid.Container><TreeGrid.Root aria-label="Release files" columnCount={2} rowCount={2} defaultExpandedValue={["src"]}><TreeGrid.Caption>Release files</TreeGrid.Caption><TreeGrid.Header><TreeGrid.Row value="header" rowIndex={1} selectable={false}><TreeGrid.ColumnHeader columnIndex={1}>Name</TreeGrid.ColumnHeader><TreeGrid.ColumnHeader columnIndex={2}>Type</TreeGrid.ColumnHeader></TreeGrid.Row></TreeGrid.Header><TreeGrid.Body><TreeGrid.Row value="src" rowIndex={2} level={1} expandable selectable><TreeGrid.RowHeader columnIndex={1}><TreeGrid.Indicator />src</TreeGrid.RowHeader><TreeGrid.Cell columnIndex={2}>Folder</TreeGrid.Cell></TreeGrid.Row></TreeGrid.Body></TreeGrid.Root></TreeGrid.Container>;
