...
- Rebuilt the mobile drawer as a branded, route-aware Brick composition with semantic surface treatment, grouped icon navigation, product resources, and a proof-oriented action footer.
