...
test("documentation rails retain readable scalable navigation", async () => {
  ...
  assert.match(componentNavSource, /import \{ Hide \} from "@flowstack-ui\/brick\/hide";[\s\S]*<Hide from="lg">\s*<div className="docs-mobile-toolbar"[\s\S]*title="Components"[\s\S]*title="On this page"/, "component pages must put mobile toolbar geometry on a child of Brick's layout-transparent Hide owner");
