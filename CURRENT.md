...
- Each reader-facing guide begins with its own compact visual map whose eyebrow, title, and balanced body-large summary share one centered axis; quiet outlined metadata remains centered beneath the setup map before practical consumer examples or verification checkpoints.
